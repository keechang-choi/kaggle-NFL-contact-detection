...
class CNN25SingleFrameDataset(Dataset):
...
class CNN25SingleFrameDataModule(pl.LightningDataModule):
    ...
    def generate_dataset(self, stage: str) -> CNN25SingleFrameDataset:
        # 학습 데이터 split을 수행한다.
        ...
        dataset = CNN25SingleFrameDataset(
